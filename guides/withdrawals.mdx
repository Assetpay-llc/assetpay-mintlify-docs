...
| `declined` | The user declined / let the Steam offer expire. Your merchant wallet is auto-refunded — refund `totalPrice` (or apply your own policy) if you previously deducted it. |
