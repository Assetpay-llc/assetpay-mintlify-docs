...
description: "Merchant-side market search returning the items a merchant can buy through the secure buy endpoint, with the same listing data as the client route."
---
