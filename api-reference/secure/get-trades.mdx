...
description: "Cursor-paginated history of trades the merchant initiated through secure sell and secure buy; end-user client trades are not included on this endpoint."
---
