...
description: "Start a Signicat PictureID verification and return the captureUrl where the user scans their document and takes a selfie to prove identity."
---
