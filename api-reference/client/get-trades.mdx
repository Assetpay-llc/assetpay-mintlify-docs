...
description: "Return the authenticated client's trade history with cursor-based pagination, filterable by trade type and game, for reconciliation and support."
---
