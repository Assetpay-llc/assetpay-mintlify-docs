...
description: "Merchant-side listing lookup for one item type; pass the returned listing id to the secure buy endpoint. Authenticated with a merchant API key."
---
