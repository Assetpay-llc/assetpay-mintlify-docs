...
description: "How Signicat PictureID verification works and what it unlocks: the verification flow, checking status, multi-account linking, and the trust cascade."
---
