...
description: "Fetch any Steam account's inventory straight from its trade URL, authenticated by merchant API key with no separate client-authentication step."
---
