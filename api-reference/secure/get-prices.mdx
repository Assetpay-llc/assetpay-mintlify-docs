---
title: "Get Prices"
description: "Return current offer prices for every item in a game, so you can sync pricing into your own database without fetching a specific user's inventory."
---
