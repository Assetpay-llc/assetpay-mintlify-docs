...
description: "Tail the AssetPay price feed over Redis Streams instead of polling: connection, access tiers, stream keys, event format, and snapshot-then-tail consumption."
---
