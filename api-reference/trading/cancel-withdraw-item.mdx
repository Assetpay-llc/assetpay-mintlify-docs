...
<Note>
CS2 (Assetpay) items only. Rust withdrawals are fulfilled by a polling supplier with no cancel API, and autoseller-sourced items leave nothing to reverse upstream; both return `TRADE_CANCEL_UNSUPPORTED` (44).
</Note>
