...
description: "The TypeScript interfaces behind every API response and callback: Trade, Item, ItemOffer, Sticker, Charm and Doppler shapes with their field types."
---
