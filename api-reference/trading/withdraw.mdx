...
| `items[].externalId` | string | No | Your own reference for this single item (1–128 chars). Echoed back on the item and accepted in place of the item id by both [cancel](/api-reference/trading/cancel-withdraw-item) endpoints. |
