...
description: "Return individual listings for one item so users can pick a specific float, sticker or phase variant instead of the cheapest available listing."
---
