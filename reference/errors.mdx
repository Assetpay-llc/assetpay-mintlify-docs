---
title: "Error Codes"
description: "Every error code the AssetPay API returns, grouped by category: general, authentication, account access, API key, trading, and async trade failures."
---
